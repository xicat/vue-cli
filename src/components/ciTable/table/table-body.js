...
import { getStyle, hasClass } from "./utils/dom";
...
export default {
  ...
  render(h) {
    ...
    let rows = this.data;
    if (
      this.store.states.lazy &&
      Object.keys(this.store.states.lazyTreeNodeMap).length
    ) {
              ...
              >
                {this._l(this.columns, (column, cellIndex) => {
                  ...
                  if (!rowspan || !colspan) {
                    ...
                    if (
                      cellIndex === this.firstDefaultColumnIndex &&
                      treeNode
                    ) {
                      data.treeNode = {
                        hasChildren:
